...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}><b>Domain:</b>Frontend Developer</h5></div>
