...
<Row>
  <Col md="12" style={{height:700,padding:20}}>
      <h1 className="Aboutme" style={{height:150,display:'flex',justifyContent:'center',alignItems:'center',color:'white',textDecorationLine:FormatUnderlined'}} >FRONT END</h1>
      <CardDeck  >
      <Card>
