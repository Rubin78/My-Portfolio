...
<Row >
        <Col md="6" sm="6" className="container2column" style={{backgroundColor:"blue"}} >
          ...
          <Col sm="9" classID="container2insider" style={{backgroundColor:'green',height:50px}}>
            ssjs
            </Col>
        </Col>
        <Col md="6" sm="6" className="container2column"  style={{backgroundColor:"orange  "}}>.col</Col>
