...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Duration    :</h5><h5 style={{width:250,backgroundColor:'green'}}>August 2019 - Present</h5></div>
