...
<Row >
  <Col md="12" className="heightofcard" >
<CardDeck md="12" sm="6" style={{height:800,backgroundColor:'red',display:'flex',alignItems:'center',flexDirection:'column'}} >
      <Card md="3" sm="12"  className="cardheight">
        <CardImg top width="50%"  alt="Card image cap" style={{}} />
        <CardBody>
          <CardText></CardText>
         
        </CardBody>
      </Card>
      <Card sm="12" className="cardheight">
        <CardImg top width="50%"  alt="Card image cap" style={{}} />
        <CardBody>
          <CardText></CardText>
      ...
      <Card sm="6" className="cardheight">
        <CardImg top width="50%"  alt="Card image cap" style={{}} />
        <CardBody>
          <CardText></CardText>
