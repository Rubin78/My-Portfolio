...
import{ Modal,closeModal,customStyles,subtitle, } from 'react-modal';
    ...
    <Card className="cardproject" >
        ...
        <div>
          <div className="textcolorbackground" >
            <Button variant="primary" onClick={openModal}  className="borderofbutttonremove"> Project Details</Button>{' '}
