...
alignItems:'space-between',justifyContent:'center',paddingLeft:40,backgroundColor:'red'}}>
  
<div style={{display:'flex',height:900,width:'100%',flexDirection:'column',justifyContent:'center',alignItems:'flex-start',marginBottom:20,}} > 
