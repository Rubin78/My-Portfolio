...
<Row>
  <Col md="12" style={{height:450,backgroundColor:'red',display:'flex',flexDirection:'column',justifyContent:'center'}}>
  ...
  <Row style={{}}>
    <div style={{display:'flex',justifyConten:'center'}}>
        <Col sm="2" className="card" >.col-6 .col-sm-4</Col>
        <Col  sm="2" className="card"  >.col-6 .col-sm-4</Col>
        <Col  sm="2" className="card"  >.col-sm-4</Col>
        <Col  sm="2" className="card"  >.col-sm-4</Col>
        <Col  sm="2"className="card"  >.col-sm-4</Col>
        <Col  sm="2" className="card" >.col-sm-4</Col>
        </div>
