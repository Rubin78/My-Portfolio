...
import hero1 from '../assests/seeit.jpg';
...
<Container fluid   className="containerBody2" style={{  backgroundImage:`url(${seeit})`,backgroundColor:'red'}}>
<Row >
        <Col md="6" sm="6" className="container2column" style={{backgroundColor:"blue"}} >

          <Col sm="9" classID="container2insider" style={{backgroundColor:'green',height:500}}>
            ssjs
            </Col>
        </Col>
        <Col md="6" sm="6" className="container2column"  style={{backgroundColor:"orange  "}}>
