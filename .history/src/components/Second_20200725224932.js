...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,height:60,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:60,backgroundColor:'green',display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:60,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold',}}>Description    :</h5><h5  style={{width:570,height:60,display:'flex',justifyContent:'center',alignItems:'center',backgroundColor:'green'}}> Solving real-time problems occuring in production related to UI</h5></div>

<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:60,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Technology    :</h5><h5 style={{width:420,height:60,display:'flex',justifyContent:'center',alignItems:'center',backgroundColor:'green'}}>React Native, React.js JavaScript,html5,Css3</h5></div>
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Duration    :</h5><h5 style={{width:220,height:50,display:'flex',justifyContent:'center',alignItems:'center',backgroundColor:'green'}}>August 2019 - Present</h5></div>
