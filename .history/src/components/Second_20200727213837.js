    ...
    <Particles
      ...
      <Navbar  data-aos="fade-right" color="red" light expand="md"  style={{display:'flex',flex:1,position:'sticky'}} >
        ...
        <Collapse isOpen={isOpen} navbar >
         ...
         <NavLink  href="/components/"  className="textheader" ><a href="#speaker">Home</a></NavLink>
         <NavLink href="/components/" className="textheader"><a href="#About">About</a></NavLink> 
...
<Container fluid   className="container2" classID="About"  style={{  backgroundImage:`url(${tosee2})`,backgroundColor:'red'}}>
<Row >
  <Col md="12">
