...
<div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',}}>
      <h1 data-aos="fade-up"
     data-aos-anchor-placement="bottom-center" className="Aboutme">Experience</h1>
      {/* <Wave text="EXAMPLE TEXT" /> */}

    </div>

    <div  style={{height:50,borderWidth:2,borderColor:'black',backgroundColor:'red'}}>skskskk</div>
    <CursorZoom
                image={{
