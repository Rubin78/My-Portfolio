...
import React, { useState, useEffect,handleMouseEnter } from 'react';
import {
  Collapse,
  Navbar,
  NavbarToggler,
...
<div>
    ...
    <Particles
      ...
      <Navbar  data-aos="fade-right" color="red" light expand="md"  style={{display:'flex',flex:1,position:'sticky'}} >
        ...
        <div  onMouseEnter={this.handleMouseEnter}> <NavLink  href="#container1"  className="textheader" >Home</NavLink></div>
