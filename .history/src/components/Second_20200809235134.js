...
<h5  className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactjs.org/">React.js</a></h5>
          ...
          <h5 className="Aboutme">
            <a className="linkcolor" target="_blank" href="https://https://css-tricks.com/snippets/css/a-guide-to-flexbox/">Html5</a></h5>
          </CardText>
          </Card>

          <Card>
          <CardImg className="imgcardradius" top width="100%" height="80%" src={flex}  />
          <CardText className="cardinside"><h5 className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactnative.dev/">Flex</a></h5>
          </CardText> 
          </Card>
          ...
          <CardText className="cardinside">
          <h5 className="Aboutme">
            <a className="linkcolor" target="_blank" href="https://reactnative.dev/">Boostrap4</a></h5>
          </CardText> 
          </Card>
    ...
    <CardDeck data-aos="fade-up-right" data-aos="flip-left"  >
          ...
          <CardText className="cardinside">
          <h5 className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactnative.dev/">JavaScript</a></h5>
          </CardText>
          </Card>
          ...
          <CardText className="cardinside">
          <h5 className="Aboutme"><a className="linkcolor" target="_blank" href="https://www.w3schools.com/css/default.asp">Reactstrap</a></h5>
          </CardText>
          </Card>
          ...
          <CardText className="cardinside">
          <h5 className="Aboutme"><a className="linkcolor" target="_blank" href="https:https://www.w3schools.com/css/default.asp">Css3</a></h5>
          </CardText>
          </Card>
...
<Card className="cardproject" >
        <CardImg   top width="100%" height="75%" src={Gymlog} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" />
        <CardText >    
...
<Col md="12" style={{display:'flex',justifyContent:'center'}}>
    ...
    {/* <div style={{textAlign:'center' ,display:'flex'}}>
       <SocialMediaIconsReact icon="Email" size={40} url="https://twitter.com/your-twitter-handle"/>  
    <SocialMediaIconsReact icon="facebook" size={40} url="https://twitter.com/your-twitter-handle"/>  
      <SocialMediaIconsReact icon="linkedin" size={40} url="https://twitter.com/your-twitter-handle"/>
      <SocialMediaIconsReact icon="facebook" size={40} url="https://twitter.com/your-twitter-handle"/>
      </div> */}
