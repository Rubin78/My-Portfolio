...
<Col sm="12"  style={{height:310,borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'blue',display:'flex',alignItems:'center',flexDirection:'column'}} >
