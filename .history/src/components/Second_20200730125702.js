...
{/* start here */}
      ...
      <Card md='12' sm="12"  style={{height:230,padding:5,display:'flex',alignItems:'space-between',justifyContent:'center',borderColor:'transparent',backgroundColor:'transparent'}}>
