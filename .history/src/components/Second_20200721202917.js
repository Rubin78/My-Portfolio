...
<Row >
        ...
        <Col sm="12" classID="container2insider" style={{backgroundColor:'brown',height:500}}>
            <div style={{height:100,display:'flex',alignItems:'center',backgroundColor:'green',fontFamily:"Gotham-Medium,Helvetica Neue,sans-serif"}}><h6>Hi there! I am Rubin Shaikh</h6></div>
            <div></div>
