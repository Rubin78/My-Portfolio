...
<Col sm="12" className="expimg" >
  <Row style={{display:'flex',justifyContent:'center',borderWidth:5,borderColor:'white'}}>
<Col sm="2" className="expimg" style={{backgroundImage:`url(${snoop})`,borderWidth:2,borderColor:'white'}}  ></Col>
<Col sm="7" className="expimg" style={{alignItems:'center',display:'flex'}}><h1 style={{color:'white'}}>Snoop Technologies Pvt. Ltd.
</h1></Col>
    </Row>
    <div style={{height:20,}}></div>
</Col>
<Col sm="12" className="exptext" style={{height:310,borderWidth:5,borderColor:'white'}} >sjjsjsj</Col>
</Col>
</Col>
