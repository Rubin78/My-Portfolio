...
import new1 from '../assests/new1.gif';
...
<Container fluid   className="container3"  style={{  backgroundImage:`url(${new1})`}}>
<Row>
<Col md="12">
...
<Container fluid   className="container4"   style={{  backgroundImage:`url(${new1})`}}>
...
<Container fluid   className="container5" style={{  backgroundImage:`url(${new1})`}}  >
