...
<div style={{display:'flex',height:450,flexDirection:'column',justifyContent:'flex-end',alignItems:'flex-start',marginBottom:20,}} > 
    ...
    <div style={{color:'white',fontSize:48,textAlign:'center',fontFamily:"Patua One",fontWeight:"bolder",letterSpacing:'.20em'}} >
    <div style={{display:'flex',flex:1,justifyContent:'center',alignItems:'flex-end',color:'#ffffff'}}>HELLO,</div>
