...
<div>
    ...
    <div style={{backgroundColor:'transparent',height:90,display:'flex',backgroundColor:'red',}}>

      
      <Navbar color="red" light expand="md"  style={{display:'flex',flex:1,position:'fixed',top:20,flexDirection:'row-reverse'}} >
