...
<Row>
  <Col md="12" style={{height:450,backgroundColor:'red'}}>
  ...
  <Row>
        ...
        <Col sm="3" style={{color:'white',height:200,backgroundColor:'yellow'}}>.col-6 .col-sm-4</Col>
        <Col  sm="3">.col-6 .col-sm-4</Col>
        <Col  sm="3">.col-sm-4</Col>
        <Col  sm="3">.col-sm-4</Col>
      </Row>
