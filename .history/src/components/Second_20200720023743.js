...
<div  Col-sm-12  style={{ display:'flex',flex:1,backgroundColor:'red',
alignItems:'space-between',justifyContent:'center',paddingLeft:40,}}>
<div style={{display:'flex',height:500,flexDirection:'column',justifyContent:'flex-end',alignItems:'flex-start'}} > 
    <div style={{color:'white',fontSize:50,textAlign:'center'}} >Rubin design +innovation</div>
