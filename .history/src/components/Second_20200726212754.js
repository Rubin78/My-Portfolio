...
<div style={{height:100,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white',marginBottom:20}}>
    ...
    <Card className="cardproject" >
        <CardImg   top width="100%" height="76%" src={github} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" />
        <CardText className="cardinside">    

        <div>
          <div style={{height:35,backgroundColor:'red',textAlign:'center'}}><Button color="secondary"> Project Details</Button>{' '} </div>
        {/* <Button color="secondary">Details</Button>{' '} */}
      <div style={{display:'flex',justifyContent:'center',alignItems:'center',height:60,backgroundColor:'red',padding:5}}><Button color="success">See Live</Button>{' '}
      ...
      <Button color="success">Watch Video</Button>{' '}
        ...
        <Card className="cardproject" >
        <CardImg top width="100%" height="80%" src={download} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" />
        <CardText className="cardinside">
          
          
        <div>
        <Button color="secondary">Details</Button>{' '}
      <Button color="secondary">See Live</Button>{' '}
      ...
      <Button color="secondary">Watch Video</Button>{' '}
        ...
        <Card className="cardproject" >
        <CardImg top width="100%" height="80%" src={bitbucket} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" />
        <CardText className="cardinside">
      ...
      <Button color="secondary">Watch Video</Button>{' '}
        ...
        <Card  className="cardproject" >
        <CardImg top width="100%" height="80%" src={unnamed} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" />
        <CardText className="cardinside">
