...
<div>
    ...
    <div style={{backgroundColor:'transparent',height:90,display:'flex'}}>
      ...
      <Navbar color="red" light expand="md"  style={{display:'flex',flex:1,position:'sticky',top:0,position:'fixed',backgroundColor:'green',justifyContent:'flex-end',alignItems:'center'}} >
