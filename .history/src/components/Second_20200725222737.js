...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Description    :</h5><h5 style={{width:780,backgroundColor:'green'}}> Solving real-time problems occuring in production related to UI, Backend, and Databases.</h5></div>
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
