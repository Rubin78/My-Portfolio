...
{/* start here */}
      ...
      <Card md='12' sm="12"  style={{height:230,padding:5,display:'flex',alignItems:'space-around',justifyContent:'center',borderColor:'transparent',backgroundColor:'transparent'}}>
