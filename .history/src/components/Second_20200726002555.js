...
<Col   data-aos="fade-left" className="expimg" style={{alignItems:'center',display:'flex'}}><h1 style={{color:'white',borderWidth:2,borderBottomColor:'red'}}>Snoop Technologies Pvt. Ltd.
</h1></Col>
    </Row>
