...
<Row  style={{display:'flex',justifyContent:'center'}}>
        <Col md="6" sm="6" className="container2column" style={{height:700,backgroundColor:'red'}} >

          <Col sm="12" classID="container2insider" style={{backgroundColor:'green',height:500}}>
            ssjs
            </Col>
        </Col>
        <Col md="6" sm="6" xs="12" className="container2column"  style={{height:900,backgroundColor:'green'}}>


        <Col sm="12" classID="container2insider" style={{backgroundColor:'yellow',height:500}}>
            {/* <div className="seondfontfamily" style={{height:100,display:'flex',alignItems:'center',backgroundColor:'green'}}><h6>Hi there! I am Rubin Shaikh</h6></div>
            <Col sm="12" style={{width:600,lineHeight:2}}>
