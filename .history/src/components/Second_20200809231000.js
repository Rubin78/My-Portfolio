...
<Container fluid   id="container2" style={{  backgroundImage:`url(${tosee2})`,backgroundColor:'red'}}>
          ...
          <Col md="5" sm="6" className="container2column" style={{}} >
          <Col sm="8" className="photoheight" classID="container2insider" >
          < img src={profile1} style={{height:'100%'}} />
          </Col>
          </Col>

            <Col md="8" sm="6" className="container2column">
