...
<Col sm="12"  style={{height:310,borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'#6e1f22',display:'flex',alignItems:'center',flexDirection:'column'}} >
...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><Col sm="6"><h5 style={{width:130,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold',}}>Description    :</h5><h5  style={{width:570,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Solving real-time problems occuring in production related to UI</h5></div>
