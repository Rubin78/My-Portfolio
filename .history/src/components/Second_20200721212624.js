...
<Row >
        <Col md="6" sm="6" className="container2column" style={{}} >
          ...
          <Col sm="12" classID="container2insider" style={{backgroundColor:'green',height:500}}>
            ssjs
            </Col>
        </Col>
        <Col md="6" sm="6" className="container2column"  style={{}}>
        ...
        <Col sm="12" classID="container2insider" style={{height:500,display:'flex',flex:1,justifyContent:'center',alignItems:'center'}}>
           <div style={{backgroundColor:'red',height:400}}> <div  style={{height:100,display:'flex',alignItems:'center',}}>
              
              <h6 className="secondfontfamily">Hi there! I am Rubin Shaikh</h6></div>
            <p className="secondfontfamily" style={{width:600,lineHeight:2}}>
              A passionate programmer , born and brought up in India. I am a  Web Developer with React.js, React.Native,JavaScript, Flex,Boostrap4,Html5,Css3.
