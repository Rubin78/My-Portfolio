...
<Row>
  <Col md="12" style={{height:700,backgroundColor:'red',padding:20}}>
      ...
      <CardDeck  >
      <Card>
        <CardImg top width="100%" height="80%" src={hero1} alt="Card image cap" />
        <CardText style={{backgroundColor:'red',height:80,textAlign:'center',display:'flex',alignItems:'center',justifyContent:'center'}}><h5 className="Aboutme">React.js</h5></CardText>
