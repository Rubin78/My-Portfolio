    ...
    <Particles
      ...
      <Navbar  data-aos="fade-right" color="red" light expand="md"  style={{display:'flex',flex:1,position:'sticky'}} >
        ...
        <Collapse isOpen={isOpen} navbar >
         ...
         <NavLink href="/components/" className="textheader"><a href="#container2">About</a></NavLink> 
...
<Container fluid    classID="container2"  style={{  backgroundImage:`url(${tosee2})`,backgroundColor:'red'}}>
<Row >
  <Col md="12">
