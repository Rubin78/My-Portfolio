...
<div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white'}}>
      <h1 data-aos="fade-up-right"   data-aos="flip-left" className="Aboutme">TECH SKILLS</h1>
    </div>
...
<Row>
  <Col md="12" style={{height:700,padding:20}}>
      <h1 data-aos="fade-up-right"   data-aos="flip-left" className="Aboutme" style={{height:150,display:'flex',justifyContent:'center',alignItems:'center',color:'white'}} >FRONT END</h1>
...
<div style={{height:100,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white',marginBottom:20}}>
      <h1 className="Aboutme">Hosting Platform</h1>
    </div>
    <CardDeck> 
    <Card>
...
<Container fluid   className="container5" style={{  backgroundImage:`url(${color})` }} >
<Col md="12">
...
<div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',}}>
    ...
    <div data-aos="fade-up" style={{height:50,borderWidth:2,borderColor:'black',backgroundColor:'red'}}>skskskk</div>
