...
<Col sm="2" className="expimg" style={{backgroundColor:'yellow',backgroundImage:`url(${snoop})`}}  >sjsjs</Col>
<Col sm="7" className="expimg" style={{backgroundColor:'orange',alignItems:'center',display:'flex'}}><h1 style={{color:'white'}}>Snoop Technologies Pvt. Ltd.
</h1></Col>
    </Row>
</Col>
