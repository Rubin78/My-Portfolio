...
import styles from '../Second/Example.module.css'
const Example = (props) => {
  const [isOpen, setIsOpen] = useState(false);
  ...
  return (
    ...
    <Container fluid className={styles.containerBody}  style={{  backgroundImage:`url(${hero1})`,backgroundPosition:'center',backgroundSize:'cover' ,height:980}} >
