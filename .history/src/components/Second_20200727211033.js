...
import{ Modal,closeModal,customStyles,subtitle,modalIsOpen ,afterOpenModal} from 'react-modal';
    ...
    <Card className="cardproject" >
        ...
        <div>
          <div className="textcolorbackground" >
            <Button variant="primary" className="borderofbutttonremove"> Project Details</Button>{' '}
      ...
      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center',height:60,backgroundColor:'blue',}}>
       <div><Button color="success">See Live</Button>{' '}
