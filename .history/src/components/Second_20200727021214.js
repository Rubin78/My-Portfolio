...
<Col md="12" style={{display:'flex',justifyContent:'center'}}>
    <Card  md="8" style={{height:130,width:"50%", display:'flex',justifyContent:'space-evenly',alignItems:'center',backgroundColor:'blue',}}>
    <div style={{}}>
        <Button color="success">See Live</Button>{' '}
      <Button color="success">Source Code</Button>{' '}
      <Button color="success">Watch Video</Button>{' '}
...
<Col md="12" style={{backgroundColor:'white',height:80,display:'flex',justifyContent:'center',alignItems:'center'}}>
<h4 style={{color:}}>© RUBIN SHAIKH    2020</h4>
  </Col>
