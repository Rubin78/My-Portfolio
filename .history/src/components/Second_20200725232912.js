...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{height:50,backgroundColor:'red',display:'flex',alignItems:'center'}} ><b>Description    :</b> Solving real-time problems occuring in production related to UI</h5></div>
