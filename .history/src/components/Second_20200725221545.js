...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,backgroundColor:'blue'}}>Domain:Frontend Developer</h5><h5 style={{width:200,backgroundColor:'green'}}>     sjsj</h5></div>
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
