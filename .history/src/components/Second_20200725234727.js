...
<Col md ="10" style={{backgroundColor:'orange',display:'flex',justifyContent:'center',flexDirection:'column',alignItems:'center'}}>
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,height:60,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:60,backgroundColor:'green',display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
