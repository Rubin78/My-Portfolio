...
<Containerfluid   id="container2" style={{  backgroundImage:`url(${tosee2})`,}}>
          <Row >
          <Col md="12">
...
<div className="container3" id="container3" >
  ...
  <Col md="12" className="Container2frontend">
          ...
          <Col sm="3" md="3"><AnimationWrapper  className="hoverwidthcards" ><Card className="card">
...
<h5  className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactjs.org/">React.js</a></h5>
          ...
          <Col sm="3" >
          <AnimationWrapper className="hoverwidthcards" ><Card className="card">
