...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,height:60,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:60,display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:60,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Technology    :</h5><h5 style={{width:420,height:60,display:'flex',justifyContent:'center',alignItems:'center'}}>React Native, React.js JavaScript,html5,Css3</h5></div>
