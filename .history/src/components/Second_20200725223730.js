...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,height:60,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:60,backgroundColor:'green'}}> Frontend Developer</h5></div>
...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Duration    :</h5><h5 style={{width:420,backgroundColor:'green'}}>August 2019 - Present</h5></div>
