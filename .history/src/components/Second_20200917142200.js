...
{/* <========= HEADER START====================> */}
            ...
            <Navbar  data-aos="fade-right" color="red"  light expand="sm"   className="navbar">
        ...
        <NavLink  href="#container2"  className="textheader"  >Home</NavLink>
        ...
        <NavLink href="#container3" className="textheader">Experience</NavLink>
