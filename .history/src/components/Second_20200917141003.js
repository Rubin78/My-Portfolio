...
{/* <========= HEADER START====================> */}
        ...
        <NavItem><NavLink href="#container2" className="textheader">About</NavLink> </NavItem>
        <NavItem></NavItem><NavLink href="#container3" className="textheader"><a onClick="#container3">Skills</a></NavLink></Collapse>
