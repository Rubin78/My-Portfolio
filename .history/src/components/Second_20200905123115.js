...
{/* start here */}
      ...
      <Col md="8" sm="12" className="textofdowncardsnoop"><h6 textofdowncardsnoopinside><b>Technology:</b> React Native, React.js , JavaScript,html5,Css3 </h6></Col>
      <Col md="8" sm="12" className="textofdowncardsnoop"><h6 textofdowncardsnoopinside><b>Duration:</b> August 2019 - Present </h6></Col>
      </Row>
      </Card>
      </Col>
      </Col>
...
<div className="experiencetextheight" >
    ...
    <AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="75%" className="Projectcardimgheight" src={logo1}  alt="Card image cap" /></AnimationWrapper>
        <CardText >    
