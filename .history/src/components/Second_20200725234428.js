...
<Col sm="12"  style={{height:310,borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'  background-color:#6e1f22',display:'flex',alignItems:'center',flexDirection:'column'}} >
