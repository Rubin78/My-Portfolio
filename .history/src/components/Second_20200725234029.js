...
<div style={{color:'white',display:'flex',flexDirection:'row',width:'100%'}}><h5 style={{height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold',}}>Description    :</h5><h5  style={{width:570,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Solving real-time problems occuring in production related to UI</h5></div>
