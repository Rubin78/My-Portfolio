...
alignItems:'space-between',justifyContent:'center',paddingLeft:40,backgroundColor:'red',width:'100%'}}>
  
<div style={{display:'flex',height:900,flexDirection:'column',justifyContent:'center',alignItems:'flex-start',marginBottom:20,}} > 
