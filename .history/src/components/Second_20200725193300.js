...
<Row style={{width:350,height:50,backgroundColor:'red',justifyContent:'center'}}>

  <Col sm="12" style={{backgroundColor:'yellow'}}><h5 style={{fontWeight:'bold'}}> Domain :</h5></Col>
  <Col sm="8"><h5 style={{color:'white'}} >Frontend Developer </h5></Col>
</Row>

<Row style={{width:350,backgroundColor:'red'}}>

  <Col sm="4"><h5 style={{fontWeight:'bold'}}>Description</h5></Col>
  <Col sm="8"><h5 style={{color:'white'}} ></h5></Col>
</Row>
