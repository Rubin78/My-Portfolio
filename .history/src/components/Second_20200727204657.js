...
import {
  ...
  CardSubtitle, CardBody,Modal,ModalBody,ModalFooter,ModalHeader
    ...
    <Card className="cardproject" >
        ...
        <div>
          <div className="textcolorbackground" >
            <Button variant="primary" onClick={handleShow}  className="borderofbutttonremove"> Project Details</Button>{' '}
