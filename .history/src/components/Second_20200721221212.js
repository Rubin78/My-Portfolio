...
<Row >
        ...
        <Col md="6" sm="6" className="container2column"  style={{display:'flex',flexDirection:'column'}}>


        <Col sm="12" classID="container2insider" style={{backgroundColor:'brown',height:800,flex:1,alignItems:'center',justifyContent:'center',display:'flex'}}>
            ...
            <Col sm="8" style={{width:600,lineHeight:2}}>
