...
<div  Col-sm-12 style={{height:600,width:500,display:flex,flex:1,alignItems:'center',justifyContent:'center',backgroundColor:'red'}}>

    <h1 style={{color:'white',fontSize:50}} >Rubin design + innovation</h1>
