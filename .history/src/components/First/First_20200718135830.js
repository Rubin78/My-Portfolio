...
<div  Col-sm-12  style={{ display:'flex',height:600,flex:1,alignItems:'space-between',justifyContent:'center',backgroundColor:'red',padding:20}}>
<div style={{display:'flex',flex:1,flexDirection:'column',justifyContent:'center',alignItems:'flex-start'}} > 
    <h1 style={{color:'white',fontSize:50,textAlign:'center',padding:20}} >Rubin design + innovation</h1>
