...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,padding:10,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:60,backgroundColor:'green',display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
