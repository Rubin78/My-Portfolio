...
<div style={{height:100,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white',marginBottom:20}}>
    ...
    <Card className="cardproject" >
        <CardImg   top width="100%" height="80%" src={github} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" />
        <CardText className="cardinside">    

        <div>
          <div style={{height:40,backgroundColor:'red'}}><Button color="secondary">Details</Button>{' '} </div>
        {/* <Button color="secondary">Details</Button>{' '} */}
      <Button color="primary">See Live</Button>{' '}
      <Button color="primary">Source Code</Button>{' '}
