...
<Row>
  <Col md="12" style={{height:700,padding:20}}>
    ...
    <Col md="12">
<div style={{height:200,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white'}}>
      <h1 className="Aboutme">TECH SKILLS</h1>
    </div>
...
<Container fluid   className="container4" style={{  backgroundColor:'black'}}>
