...
{/* <========= HEADER START====================> */}
        ...
        <NavItem><NavLink  href="#container1"  className="textheader"  >Home</NavLink></NavItem>
        <NavItem><NavLink href="#container2" className="textheader" data-target="/navbarSupportedContent">About</NavLink> </NavItem>
