...
<Row>
  <Col md="12" style={{height:500,backgroundColor:'red'}}>
      <h1 className="Aboutme" style={{height:150,backgroundColor:'green',display:'flex',justifyContent:'center',alignItems:'flex-end'}} >FRONT END</h1>
  <Row>
    
  <div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white'}}>
    
    </div>
        <Col sm="3" style={{color:'white'}}>.col-6 .col-sm-4</Col>
