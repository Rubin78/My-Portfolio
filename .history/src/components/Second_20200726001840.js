...
<Col sm="2"xs='6'  data-aos="fade-up-left" className="expimg" style={{backgroundImage:`url(${snoop})`}}  ></Col>
<Col sm="7" xs='6'  data-aos="fade-left" className="expimg" style={{alignItems:'center',display:'flex'}}><h1 style={{color:'white',borderWidth:2,borderBottomColor:'red'}}>Snoop Technologies Pvt. Ltd.
</h1></Col>
    </Row>
