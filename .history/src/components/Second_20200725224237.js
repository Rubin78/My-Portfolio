...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:60,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold',}}>Description    :</h5><h5  style={{width:570,backgroundColor:'green'}}> Solving real-time problems occuring in production related to UI</h5></div>
...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Duration    :</h5><h5 style={{width:220,backgroundColor:'green'}}>August 2019 - Present</h5></div>
