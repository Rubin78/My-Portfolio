...
<AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="100%" className="Projectcardimgheight" src={logo1} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" /></AnimationWrapper>
      ...
      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center',height:77}}>
         <Col><AnimationWrapper><Button color="success"><a className="linkcolor mob-sizefont" target="_blank" href="https://apkpure.com/u/12647160/post/8817223">See Live</a></Button>{' '}</AnimationWrapper>
         ...
         <AnimationWrapper><Button color="success"><a className="linkcolor mob-sizefont" target="_blank" href="https://www.youtube.com/watch?v=N6rglB2ud_4&feature=youtu.be">Watch Video</a></Button>{' '}</AnimationWrapper>  </Col>    </div>
       </div>
