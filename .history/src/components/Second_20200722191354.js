...
<Row>
  <Col md="12" style={{height:700,backgroundColor:'red',padding:20}}>
      <h1 className="Aboutme" style={{height:150,backgroundColor:'green',display:'flex',justifyContent:'center',alignItems:'center'}} >FRONT END</h1>
      <CardDeck  >
      <Card>
        ...
        <Card>
        <CardImg top width="100%" height="80%" src={reactjs} alt="Card image cap" />
        <CardText className="cardinside"><h5 className="Aboutme">React Native</h5></CardText> </Card>


        <Card>
        <CardImg top width="100%" height="80%" src={html5} alt="Card image cap" />
        <CardText className="cardinside"><h5 className="Aboutme">Html5</h5></CardText> </Card>



        <Card>
        <CardImg top width="100%" height="80%" src={flex} alt="Card image cap" />
        <CardText className="cardinside"><h5 className="Aboutme">Flex</h5></CardText> </Card>


        <Card>
        <CardImg top width="100%" height="80%" src={boostrap} alt="Card image cap" />
    ...
    <CardDeck>
    <Card>
        <CardImg top width="100%" height="80%" src={testing} alt="Card image cap" />
        <CardText className="cardinside"><h5 className="Aboutme">Java</h5></CardText> </Card>
        <Card>
        <CardImg top width="100%" height="80%" src={article} alt="Card image cap" />
        <CardText className="cardinside"><h5 className="Aboutme">React.js</h5></CardText> </Card>
        <Card>
