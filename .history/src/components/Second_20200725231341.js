...
<Col sm="12"  style={{height:310,width:400,borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'#6e1f22',display:'flex',alignItems:'center',flexDirection:'column'}} >
...
<Col md ="10" style={{display:'flex',justifyContent:'center',flexDirection:'column',alignItems:'center'}}>
<div style={{color:'white',fontSize:30}}><Col sm="12" style={{backgroundColor:'red',textAlign:'center'}} >Junior Software Developer </Col></div> 
<div md="12" sm="12" style={{backgroundColor:'blue',color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold',}}>Description    :</h5><h5  style={{width:570,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Solving real-time problems occuring in production related to UI</h5></div>

<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Technology    :</h5><h5 style={{width:420,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}>React Native, React.js JavaScript,html5,Css3</h5></div>
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:130,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Duration    :</h5><h5 style={{width:220,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}>August 2019 - Present</h5></div>
