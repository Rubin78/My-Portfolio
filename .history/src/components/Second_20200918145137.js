...
<div style={{height:200,display:'flex',justifyContent:'center',alignItems:'center',color:'white',marginBottom:20}}>
    ...
    <Card className="cardproject" >
        ...
        <div>
          <div className="textcolorbackground" >
            <Button  className="borderofbutttonremove"> Project Details</Button>{' '} 
            </div>
        {/* <Button color="secondary">Details</Button>{' '} */}
      <div style={{display:'flex',justifyContent:'space-evenly',alignItems:'center',height:77,}}>
        <Button color="success">See Live</Button>{' '}
      <Button color="success">Source Code</Button>{' '}
      <Button color="success">            <a className="linkcolor" target="_blank" href="https://www.youtube.com/watch?v=PyQ79mxrCq0&feature=youtu.be">Watch Video</a></Button>{' '}
      </div>
       </div>
