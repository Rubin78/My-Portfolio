...
<Card className="cardproject"  >
<AnimationWrapper className="projectcardhoverheight"><CardImg   top width="100%" height="75%" className="Projectcardimgheight" src={Gymlog} style={{borderTopLeftRadius:8,borderTopRightRadius:8}} alt="Card image cap" /></AnimationWrapper>
        <CardText >    
