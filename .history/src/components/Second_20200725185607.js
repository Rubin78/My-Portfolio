...
<Col sm="7" className="expimg" style={{alignItems:'center',display:'flex'}}><h1 style={{color:'white',borderWidth:2,borderBottomColor:'red'}}><u>Snoop Technologies Pvt. Ltd.</u>
</h1></Col>
    </Row>
    <div style={{height:20,}}></div>
</Col>
<Col sm="12"  style={{height:310,borderWidth:5,borderColor:'white',borderColor:'#c4c4c4',backgroundColor:'blue'}} >sjjsjsj</Col>
</Col>
</Col>
