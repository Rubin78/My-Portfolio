...
<Row >
  <Col md="12">
    <div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',}}>
      <h1  data-aos="fade-up"  className="Aboutme">ABOUT ME</h1>
    </div>
    <Row>
...
<Row>
  <Col md="12" style={{height:700,padding:20}}>
      ...
      <CardDeck  >
      <Card data-aos="fade-zoom-in" data-aos-offset="200" data-aos-easing="ease-in-sine" data-aos-duration="600">
...
<div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',}}>
    ...
    <div data-aos="fade-down" style={{height:20,borderWidth:2,borderColor:'black',backgroundColor:'red'}}>skskskk</div>
