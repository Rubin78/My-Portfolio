...
<Row>
  <Col md="12" style={{height:450,backgroundColor:'red',justifyContent:'center',display:'flex'}}>
  ...
  <Row>
        ...
        <Col sm="2" style={{color:'white',height:200,backgroundColor:'yellow'}}>.col-6 .col-sm-4</Col>
        <Col  sm="2">.col-6 .col-sm-4</Col>
        <Col  sm="2">.col-sm-4</Col>
        <Col  sm="2">.col-sm-4</Col>
      </Row>
