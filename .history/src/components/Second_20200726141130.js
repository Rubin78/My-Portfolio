...
<Row style={{justifyContent:'center',display:'flex',backgroundColor:'blue'}}>
  ...
  <Col md="6" data-aos="fade-left" className="expimg"  style={{height:120,backgroundColor:'green',alignItems:'center',display:'flex'}}><h1>Snoop Technologies Pvt. Ltd.</h1></Col>
  </Row>
</Col>
