...
<Col sm="12" className="expimg" >
  <Row>
<Col sm="3" className="expimg" style={{backgroundColor:'yellow'}}>sjsjs</Col>
<Col sm="9" className="expimg" style={{backgroundColor:'orange'}}>ssj</Col>
    </Row>
</Col>
<Col sm="12" className="exptext" style={{backgroundColor:'black',height:310}} >sjjsjsj</Col>
</Col>
</Col>
