...
{/* start here */}
      ...
      <Col md="8" sm="12" className="textofdowncardsnoop" style={{padding:10}}><h6><b>Description :</b>Solving real-time problems occuring in production related to UI</h6></Col>
