...
<Row style={{justifyContent:'center',display:'flex',backgroundColor:'blue'}}>
  ...
  <Col md="5.5" data-aos="fade-left" className="expimg"  style={{height:120,backgroundColor:'green',alignItems:'center',justifyContent:'center',display:'flex'}}><h2>Snoop Technologies Pvt. Ltd.</h2></Col>
  </Row>
</Col>
