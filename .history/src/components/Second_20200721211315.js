...
<Row >
        ...
        <Col  sm="12"   classID="container2insider" style={{height:700,backgroundColor:'red',display:'flex',flexDirection:'column',alignItems:'center'}}>
            <div  style={{height:100,display:'flex',alignItems:'center',}}><h6 className="secondfontfamily">Hi there! I am Rubin Shaikh</h6></div>
            <p  className="secondfontfamily" style={{lineHeight:2}}>
