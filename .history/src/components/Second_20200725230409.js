...
<div md="6"  style={{backgroundColor:'blue',color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
