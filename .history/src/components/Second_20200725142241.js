...
<Col sm="12" className="expimg" >
  <Row>
<Col sm="3" className="expimg" style={{backgroundColor:'yellow',backgroundImage:`url(${snoop})`}}  >sjsjs</Col>
<Col sm="9" className="expimg" style={{backgroundColor:'orange'}}><h1>Snoop Technologies Pvt. Ltd.
</h1></Col>
    </Row>
</Col>
