...
<Col md="12" sm="12"  style={{height:310,borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'  background-color:#6e1f22',display:'flex',alignItems:'center',flexDirection:'column',backgroundColor:'green'}} >
...
<Col md ="12" style={{backgroundColor:'orange',display:'flex',justifyContent:'center',flexDirection:'column',alignItems:'center'}}>
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{width:120,padding:10,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,padding:10,backgroundColor:'green',display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
