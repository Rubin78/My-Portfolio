...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h4 style={{width:120,backgroundColor:'blue'}}>sshsh</h4><h4 style={{width:200,backgroundColor:'green'}}>     sjsj</h4></div>
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
<h2 style={{color:'white',}}>Junior Software Developer </h2> 
