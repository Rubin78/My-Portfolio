...
<h5  className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactjs.org/">React.js</a></h5>
          ...
          <Col sm="3" >
          <AnimationWrapper className="hoverwidthcards" ><Card id="Top-cards" boxShadow={3}>
          ...
          <Col sm="3" md="3"><AnimationWrapper className="hoverwidthcards" ><Card id="Top-cards"  boxShadow={3}>
