...
<Row >
        <Col md="6" sm="6" className="container2column" style={{height:900,backgroundColor:'red'}} >
        ...
        <Col sm="12" classID="container2insider" style={{backgroundColor:'brown',height:800}}>
