...
<div style={{color:'white',display:'flex',flexDirection:'row'}}><h5 style={{padding:10,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}><b>Domain:</b>Frontend Developer</h5></div>
