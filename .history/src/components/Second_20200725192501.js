...
<Row style={{width:350,backgroundColor:'red',display:'flex',alignItems:'center',justifyContent:'center'}}>

  <Col sm="3"><h5>Domain :</h5></Col>
  <Col sm="9"><p style={{fontSize:21}}>Frontend Developer </p></Col>
</Row>
