...
<div style={{color:'white',display:'flex',flexDirection:'row',width:'100%'}}><h5 style={{height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Technology    :</h5><h5 style={{width:420,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}>React Native, React.js JavaScript,html5,Css3</h5></div>
