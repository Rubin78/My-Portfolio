...
{/* start here */}
      ...
      <Card md='12' sm="12"  style={{height:230,padding:5,display:'flex',alignItems:'space-evenly',justifyContent:'center',borderColor:'transparent',backgroundColor:'transparent'}}>
