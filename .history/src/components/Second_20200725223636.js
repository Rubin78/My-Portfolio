...
<div style={{color:'white',display:'flex',flexDirection:'row',height:50}}><h5 style={{width:120,backgroundColor:'blue',justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{width:200,backgroundColor:'green'}}> Frontend Developer</h5></div>
