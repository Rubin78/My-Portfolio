...
<div id="container7" style={{height:200,display:'flex',justifyContent:'center',alignItems:'flex-end',color:'white',marginBottom:20}}>
      <h1 data-aos="fade-up-left" className="Aboutme">Contact</h1>
    </div>


<Col md="12" style={{display:'flex',justifyContent:'center'}}>
    <Card  style={{height:130,width:"70%", display:'flex',justifyContent:'space-evenly',alignItems:'center',backgroundColor:'transparent',borderColor:'transparent'}}>
