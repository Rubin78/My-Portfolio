...
import hjb from '../assests/hjb.jpg';
...
<Container fluid   id="container2" style={{  backgroundImage:`url(${hjb})`,backgroundColor:'red'}}>
<Row >
  <Col md="12">
    ...
    <Row>
        ...
        <Col sm="12" classID="container2insider" style={{}}>
            ...
            <Col sm="8" className="seondfontfamily"  style={{lineHeight:1.8,color:'white'}}>
