...
<Col sm="12"  xs="12" style={{height:310,width:'100%',borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'#6e1f22',flexDirection:'column'}} >
...
<div md="12" sm="12" style={{backgroundColor:'blue',color:'white',display:'flex',flexDirection:'row',width:'100%'}}><h5 sm="6" style={{height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold'}}>Domain    :</h5><h5 style={{height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Frontend Developer</h5></div>
<div style={{color:'white',display:'flex',flexDirection:'row',width:'100%'}}><h5 style={{width:130,height:50,justifyContent:'center',alignItems:'center',display:'flex',fontWeight:'bold',}}>Description    :</h5><h5  style={{width:570,height:50,display:'flex',justifyContent:'center',alignItems:'center'}}> Solving real-time problems occuring in production related to UI</h5></div>
