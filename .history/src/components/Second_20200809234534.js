...
<h5  className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactjs.org/">React.js</a></h5>
          ...
          <h5 className="Aboutme">
            <a className="linkcolor" target="_blank" href="https://reactnative.dev/">Html5</a></h5>
          </CardText>
          </Card>
    ...
    <CardDeck data-aos="fade-up-right" data-aos="flip-left"  >
          ...
          <CardText className="cardinside">
          <h5 className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactnative.dev/">Reactstrap</a></h5>
          </CardText>
          </Card>
          ...
          <CardText className="cardinside">
          <h5 className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactnative.dev/">Css3</a></h5>
          </CardText>
          </Card>
