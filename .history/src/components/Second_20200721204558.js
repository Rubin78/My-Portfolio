...
<Row >
        ...
        <Col sm="12" classID="container2insider" style={{backgroundColor:'brown',height:500}}>
            <div style={{height:100,display:'flex',alignItems:'center',backgroundColor:'green'}}><h6>Hi there! I am Rubin Shaikh</h6></div>
            <p style={{width:600,lineHeight:10}}>A passionate programmer and a Coach, born and brought up in India. I am a Full Stack Web Developer with React.js, Django, Express.js, Node.js, and PostgreSQL as my tech stack.
