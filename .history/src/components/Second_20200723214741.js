...
import spectral from '../assests/spectral.gif';
...
<Container fluid   className="container5" style={{  backgroundImage:`url(${spectral})` ,backgroundSize:500,backgroundRepeat:no-Repeat}} >
