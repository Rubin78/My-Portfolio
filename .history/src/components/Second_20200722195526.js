...
import React, { TextStyle } from 'react';
import {
  Collapse,
  Navbar,
  NavbarToggler,
...
<Row>
  <Col md="12" style={{height:700,padding:20}}>
      <h1 className="Aboutme" style={{height:150,display:'flex',justifyContent:'center',alignItems:'center',color:'white',TextStyle: {textDecorationLine: 'Underline'}}} >FRONT END</h1>
      <CardDeck  >
      <Card>
