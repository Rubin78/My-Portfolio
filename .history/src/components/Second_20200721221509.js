...
<Row >
        ...
        <Col md="6" sm="6" className="container2column"  style={{flexDirection:'column',height:800,display:'flex',alignItems:'center',justifyContent:'center',flex:1}}>


        <Col sm="12" classID="container2insider" style={{backgroundColor:'brown'}}>
