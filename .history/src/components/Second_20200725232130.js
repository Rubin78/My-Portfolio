...
<Col md="12" sm="12"  xs="12" style={{borderTopWidth:5,borderTopColor:'white',borderColor:'#c4c4c4',backgroundColor:'#6e1f22',display:'flex',alignItems:'center',flexDirection:'column'}} >
