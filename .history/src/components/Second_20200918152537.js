...
<h5  className="Aboutme"><a className="linkcolor" target="_blank" href="https://reactjs.org/">React.js</a></h5>
          ...
          <Col sm="3" >
          <AnimationWrapper className="hoverwidthcards" ><Card classID="Top-cards">
...
<div className="hostingtextheader" >
    ...
    <Col sm="3"><AnimationWrapper className="hoverwidthcards" ><Card className="top-card">
    <CardImg classID="imgcardradius" top width="100%" height="80%" src={github} />
    <CardText className="cardinside"><h5 className="Aboutme">GitHub</h5></CardText></Card>
    </AnimationWrapper></Col>

    <Col sm="3"><AnimationWrapper className="hoverwidthcards" ><Card className="top-card">
    <CardImg classID="imgcardradius" top width="100%" height="80%" src={download} />
