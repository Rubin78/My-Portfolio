...
<div className="designiinovationinside" > 
    ...
    <div data-aos="fade-down-right"  className="fonttotextdesign"
    //  style={{color:'white',fontSize:42,textAlign:'center',
    //  fontFamily:"Patua One",fontWeight:"bolder",letterSpacing:'.20em'}} >
    DESIGN +
