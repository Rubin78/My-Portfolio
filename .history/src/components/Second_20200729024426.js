...
<div className="hostingtextheader" >
    ...
    <Card>
    <CardImg className="imgcard" top width="100%" height="80%" src={download} />
    <CardText className="cardinside"><h5 className="Aboutme">000webhost</h5></CardText></Card>
    <Card>
    <CardImg className="imgcard" top width="100%" height="80%" src={bitbucket}   />
    <CardText className="cardinside"><h5 className="Aboutme">BitBucket</h5></CardText>  </Card>
    <Card >
    <CardImg className="imgcard" top width="100%" height="80%" src={unnamed} />
...
{/* start here */}
      ...
      <Card md='12' sm="12" className='cardheightfont' style={{height:230,padding:5,display:'flex',alignItems:'center',justifyContent:'center',borderColor:'transparent',backgroundColor:'transparent'}}>
