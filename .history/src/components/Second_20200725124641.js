...
import { Container, Row, Col,I} from 'reactstrap';
...
<div style={{height:80,display:'flex',justifyContent:'center',alignItems:'flex-end',}}>
    ...
    <div  style={{height:480,borderWidth:2,borderColor:'black',backgroundColor:'red',padding:20}}>

<Col md="12" style={{height:440,backgroundColor:'green'}}>
<Col md="9" style={{backgroundColor:'orange'}}>
hii
</Col>
</Col>
